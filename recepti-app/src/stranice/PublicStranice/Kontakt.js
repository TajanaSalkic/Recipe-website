...
export default function ContactUs() {
    ...
    const [isSuccess, setIsSuccess] = useState(false); // State za uspješnost slanja forme
    const [message, setMessage] = useState(false); // State za poruku
  
    const apiKey = process.env.PUBLIC_ACCESS_KEY || "0e001284-b4e1-4ffa-9db4-424d2815e3ce"; // API ključ za Web3Forms
  
    const { submit: onSubmit } = useWeb3Forms({ // Korištenje Web3Forms hook-a za slanje forme
      access_key: apiKey,
      settings: {
        from_name: "Recipe App Contact Form",
        subject: "New Contact Message from your Website",
      },
      onSuccess: (msg, data) => { // Uspješno slanje forme
        setIsSuccess(true);
        setMessage(msg);
        reset();
      },
      onError: (msg, data) => { // Greška pri slanju forme
        setIsSuccess(false);
        setMessage(msg);
      },
    });
              ...
              <div className="contact-us-container">
                  ...
                  <div className="contact-form">
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {/* da li je slanje uspješno ili ne */}
