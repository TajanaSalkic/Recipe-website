                ...
                <div className="contain">
                    {searchPerformed ? ( // Provjera da li je pretraga izvršena
                        Mymeal == null ? ( // Ako nema rezultata pretrage, prikaz poruke
                            ...
                            // Ako ima rezultata pretrage, prikaz rezultata pomoću komponente KarticaJelo
                            Mymeal.map((res, index) => (
                                <KarticaJelo key={index} getMeal={{ data: res }} />
                            ))
                        )
                    ) : (
                        // Ako pretraga nije izvršena, prikaz nasumičnih jela pomoću komponente KarticaJelo
